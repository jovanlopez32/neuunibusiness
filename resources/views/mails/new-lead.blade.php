...
{{-- <img src="{{ $message->embed( public_path() .  '/assets/images/logo/neuuni/Neuuni Business.png') }}" class=" w-20 h-20" alt="Neuuni Business">

<h1 >Neuuni Business</h1>
<small>Bienvenido {{ $business->name }}</small>

<p>Sabemos que tener un equipo preparado puede llevar tu empresa al siguiente nivel.</p>

<p>
Es por eso que en neuuni disenamos estas rutas de aprendizaje, para que tu
<br>
y tu equipo siempre esten preparados para los retos del futuro.
<br>
En breve te contactaremos via whatsapp asi como por este medio para
<br>
poder charlar un poco sobre tu empresa {{$business->business}}.
</p> --}}
